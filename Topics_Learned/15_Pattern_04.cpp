...
void pattern3( int r)
{
    for (int i = 1; i <= r; i++)
    {
        for (int j= 1; j <= i; j++)
        {
            cout << i << " "; // Here, the row number is printed instead of "*". So, for the 1st row, there will be 1 column with value 1, for the 2nd row, there will be 2 columns with values 2 and 2, and so on.
        }
        cout << "\n";
    }
}
