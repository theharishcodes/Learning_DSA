...
void pattern5( int r)
{
    ...
    {
        for (int j= r; j >= i; j--) // Here, the number of columns decreases with the increase in the number of rows. So, for the 1st row, there will be r columns, for the 2nd row, there will be r-1 columns, and so on.
        {
            cout << "* ";
        }
        cout << "\n";
